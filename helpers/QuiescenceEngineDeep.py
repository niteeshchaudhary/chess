"""
QuiescenceEngineDeep - Advanced chess engine with quiescence search and pruning techniques.
...
class QuiescenceEngineDeep:

    def __init__(self):
        self.name = "QuiescenceEngineDeep"
    ...
    def iterative_deepening(self, board, game_obj, player, max_depth, time_limit=8.0):
    ...
    def getNextMove(self, board, game_obj, player="black", depth=10):
        ...
        move, score = self.iterative_deepening(board, game_obj, player, depth, time_limit=8.0)
